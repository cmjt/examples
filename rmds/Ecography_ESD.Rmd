...
This supplementary material provides the code used to fit the spatio-temporal marked log-Gaussian Cox process discussed in \textit{Estimating species distribution in highly dynamic populations using point process models} submitted to \textit{Ecography}. There is an onlie version of this tutorial also avaiable [here](https://github.com/cmjt/examples/blob/master/Ecography_ESD.md).
