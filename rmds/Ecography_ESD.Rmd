...
knitr::opts_chunk$set(echo = TRUE, eval = FALSE,tidy = TRUE, tidy.opts=list(blank=FALSE, width.cutoff=60))
```
...
Please note that the data cannot be supplied along with the supplementary material. \texttt{wetland} is a data frame of x rows and 16 columns. Each row corresponds to an observation, and the columns correspond to x, y ,z respectively.
