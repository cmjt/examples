...
```{r summary}
summary(fit)$fixed[,1:6] ## print out some summary information for fixed effects
summary(fit)$hyperpar[,1:6] ## print out some summary information for parameters of the latent fields
fields <- find.fields(fit, mesh, n.t = 2) ## extract the random fields from the model object over the n.t = 2 years.